<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="personelEkle.aspx.cs" Inherits="proje.personelEkle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
     <form id="Form1" runat="server">
        ...
        <div class="form-group">
            ...
            <asp:TextBox ID="TextBoxKanGrubu" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        ...
        <div class="form-group">
            ...
            <asp:TextBox ID="TextBoxPozisyon" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
        <div class="form-group">
